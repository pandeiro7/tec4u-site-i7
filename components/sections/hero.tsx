    ...
    >
      <div className="w-full relative z-10 p-4 h-200 lg:h-[89vh] lg:max-h-[660px]">
        ...
        <div className="hero-text-wrapper hero mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto max-w-2xl text-pretty text-base leading-relaxed text-gray-700 md:text-lg">
            {description}
          </p>
        </div>
      </div>

      <section className="cell-phone-sec relative pb-20 mt-[-300px] lg:mt-[-28vh]">
        <div className="container px-4 md:px-6">
          <div className="relative mx-auto max-w-7xl">
            ...
            <div className="absolute inset-0 pointer-events-none w-[85%] z-20 mx-auto">
              <div className="relative h-full">
                ...
                <div
                  className="hero-card clientes hidden lg:block absolute right-[1%] top-[5%] md:top-[10%] lg:top-[6%] w-[300px] md:w-[340px] rounded-2xl bg-white p-6 shadow-lg transition-transform duration-200 pointer-events-auto"
                  data-parallax="card"
                >
                ...
                <div
                  className="hero-card vendas absolute right-[-10%] lg:right-[1%] bottom-[-20%] md:bottom-[10%] lg:bottom-[3%] w-[300px] md:w-[340px] rounded-2xl bg-white p-6 shadow-lg transition-transform duration-200 pointer-events-auto"
                  data-parallax="card"
                >
                  <div className="card-title mb-4 text-xs font-bold uppercase tracking-wider text-gray-800">
                    vendas aumentadas
